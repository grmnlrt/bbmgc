...
gdjs.New_32sceneCode.GDGiftObjects1= [];
gdjs.New_32sceneCode.GDGiftObjects2= [];
gdjs.New_32sceneCode.GDGiftObjects3= [];
gdjs.New_32sceneCode.GDFinalScreenObjects1= [];
gdjs.New_32sceneCode.GDFinalScreenObjects2= [];
gdjs.New_32sceneCode.GDFinalScreenObjects3= [];
...
gdjs.New_32sceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(7687036);
}
...
gdjs.New_32sceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8271676);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("FinalScreen"), gdjs.New_32sceneCode.GDFinalScreenObjects1);
gdjs.copyArray(runtimeScene.getObjects("PlayerHitBox"), gdjs.New_32sceneCode.GDPlayerHitBoxObjects1);
{for(var i = 0, len = gdjs.New_32sceneCode.GDPlayerHitBoxObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDPlayerHitBoxObjects1[i].hide();
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDFinalScreenObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDFinalScreenObjects1[i].hide();
}
}}
...
{for(var i = 0, len = gdjs.New_32sceneCode.GDPlayerObjects1.length ;i < len;++i) {
    ...
    gdjs.New_32sceneCode.GDPlayerNameObjects1[i].setPosition((( gdjs.New_32sceneCode.GDPlayerHitBoxObjects1.length === 0 ) ? 0 :gdjs.New_32sceneCode.GDPlayerHitBoxObjects1[0].getPointX("")) - 15,(( gdjs.New_32sceneCode.GDPlayerHitBoxObjects1.length === 0 ) ? 0 :gdjs.New_32sceneCode.GDPlayerHitBoxObjects1[0].getPointY("")) - 28);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Gift"), gdjs.New_32sceneCode.GDGiftObjects1);
gdjs.copyArray(runtimeScene.getObjects("PlayerHitBox"), gdjs.New_32sceneCode.GDPlayerHitBoxObjects1);

gdjs.New_32sceneCode.condition0IsTrue_0.val = false;
gdjs.New_32sceneCode.condition1IsTrue_0.val = false;
{
gdjs.New_32sceneCode.condition0IsTrue_0.val = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.New_32sceneCode.mapOfGDgdjs_46New_9532sceneCode_46GDPlayerHitBoxObjects1Objects, gdjs.New_32sceneCode.mapOfGDgdjs_46New_9532sceneCode_46GDGiftObjects1Objects, false, runtimeScene, false);
}if ( gdjs.New_32sceneCode.condition0IsTrue_0.val ) {
{
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDGiftObjects1.length;i<l;++i) {
    if ( gdjs.New_32sceneCode.GDGiftObjects1[i].getOpacity() == 255 ) {
        gdjs.New_32sceneCode.condition1IsTrue_0.val = true;
        gdjs.New_32sceneCode.GDGiftObjects1[k] = gdjs.New_32sceneCode.GDGiftObjects1[i];
        ++k;
    }
}
gdjs.New_32sceneCode.GDGiftObjects1.length = k;}}
if (gdjs.New_32sceneCode.condition1IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("FinalScreen"), gdjs.New_32sceneCode.GDFinalScreenObjects1);
/* Reuse gdjs.New_32sceneCode.GDGiftObjects1 */
{for(var i = 0, len = gdjs.New_32sceneCode.GDGiftObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDGiftObjects1[i].setOpacity(254);
}
}{gdjs.evtTools.sound.playSound(runtimeScene, "139-item-catch.mp3", false, 100, 1);
}{runtimeScene.getVariables().getFromIndex(0).add(1000);
}{for(var i = 0, len = gdjs.New_32sceneCode.GDGiftObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDGiftObjects1[i].getBehavior("Tween").addObjectOpacityTween("FadeOut", 0, "easeInQuad", 300, false);
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDGiftObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDGiftObjects1[i].getBehavior("Tween").addObjectPositionYTween("MoveUp", (gdjs.New_32sceneCode.GDGiftObjects1[i].getPointY("")) - 25, "easeOutQuad", 300, false);
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDFinalScreenObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDFinalScreenObjects1[i].hide(false);
}
}}
...
gdjs.New_32sceneCode.GDGiftObjects1.length = 0;
gdjs.New_32sceneCode.GDGiftObjects2.length = 0;
gdjs.New_32sceneCode.GDGiftObjects3.length = 0;
gdjs.New_32sceneCode.GDFinalScreenObjects1.length = 0;
gdjs.New_32sceneCode.GDFinalScreenObjects2.length = 0;
gdjs.New_32sceneCode.GDFinalScreenObjects3.length = 0;
